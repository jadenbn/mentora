  ...
  return (
    <main className="grid min-h-dvh place-items-center p-6">
      <section className="max-w-lg text-center">
        ...
        <p className="mt-4 text-slate-600">Pick a course, then open a space to work in.</p>
        <Link className="mt-6 inline-block rounded-lg bg-blue-700 px-4 py-2 font-semibold text-white" href="/courses">
          My courses
        </Link>
      </section>
    </main>
